...
<form on:submit|preventDefault>
  <div class="mb-6">
    ...
    <input
      ...
      placeholder="Enter Id in number format"
    />
  ...
  <button
    ...
    class="centered-button text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-400 mr-4 mb-4"
  >
    Add Employee
